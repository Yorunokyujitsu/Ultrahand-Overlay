...
const std::string SETTINGS_PATH = "sdmc:/config/ASAP-assist/ultrahand/";
const std::string ULTRAHAND_CONFIG_INI_PATH = "sdmc:/config/ASAP-assist/ultrahand/config.ini";
//const std::string TESLA_CONFIG_INI_PATH = "sdmc:/config/tesla/config.ini";
//const std::string LANG_PATH = "sdmc:/config/ASAP-assist/ultrahand/lang/";
const std::string THEME_CONFIG_INI_PATH = "sdmc:/config/ASAP-assist/ultrahand/theme.ini";
const std::string THEMES_PATH = "sdmc:/config/ASAP-assist/ultrahand/themes/";
const std::string DOWNLOADS_PATH = "sdmc:/config/ASAP-assist/ultrahand/downloads/";
const std::string PACKAGE_PATH = "sdmc:/config/ASAP-assist/Packages/";
const std::string OVERLAY_PATH = "sdmc:/switch/.overlays/";
const std::string OVERLAYS_INI_FILEPATH = "sdmc:/config/ASAP-assist/ultrahand/overlays.ini";
const std::string PACKAGES_INI_FILEPATH = "sdmc:/config/ASAP-assist/ultrahand/packages.ini";
...
const std::string ATMO_CONTENTS_PATH = "sdmc:/atmosphere/contents/";
const std::string BACKUP_PATH = "sdmc:/backup/";
const std::string ASSIST_PATH = "sdmc:/config/ASAP-assist/";
const std::string SWITCH_PATH = "sdmc:/switch/";
const std::string UPDATER_PATH = "sdmc:/switch/ASAP-Updater/";
...
const std::string P_DEFAULT_STR = "Default";
const std::string P_AUTO_STR = "Auto";

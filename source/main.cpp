...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        if (dropdownSelection.empty()) {
            ...
            drawTable(list, menu_section1, menu_section1_text1, 30, 20, 30, 3, SECTITLE_STR, whiteColor, DEFAULT_STR, DEFAULT_STR, false);
            ...
            drawTable(list, update_section1, update_section_text1, 40, 20, 0, 0, SECTITLE_STR, whiteColor, DEFAULT_STR, DEFAULT_STR, false);
            drawTable(list, update_section2, update_section_text2, 9, 20, 30, 5, SECTITLE_STR, ACCENT_STR, DEFAULT_STR, CENTER_STR, false);
            ...
            drawTable(list, update_section3, update_section_text3, 30, 20, 0, 3, WARNING_STR, WARNING_STR, DEFAULT_STR, DEFAULT_STR, false);
            drawTable(list, update_section4, update_section_text4, 45, 20, 0, 0, SECTITLE_STR, whiteColor, DEFAULT_STR, DEFAULT_STR, false);
            drawTable(list, update_section5, update_section_text5, 9, 20, 30, 0, SECTITLE_STR, ACCENT_STR, DEFAULT_STR, CENTER_STR, false);
